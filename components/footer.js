export default function Footer() {
  return (
    <footer className="container md:mx-auto mt-10 mb-14 w-screen">
      <div>
        <h1 className="text-blck font-black text-2xl">You're in good hands.</h1>
      </div>
      ...
      <div className="grid text-center lg:text-justify grid-cols-1 lg:grid-cols-4 mt-6">
        ...
        <div>
          <p className="text-black font-black text-base">© Mookh Africa Ltd.</p>
        </div>
      </div>
    </footer>
  );
