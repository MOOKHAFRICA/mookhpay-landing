export default function PricingCard() {
  return (
    <div className="bg-cwc-featuresbg hover:bg-gradient-to-r from-cwc-fone to-cwc-tone rounded-3xl p-12 opacity-80 mx-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <div className="mt-4 md:mt-32 lg:mt-20">
            ...
            <div>
              <p className="text-white opacity-70 font-extrabold mt-3">Kenya</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div>
          <div>
            <p className="text-white opacity-70 lg:text-lg mb-6 font-extrabold">
              Card Payments
            </p>
          </div>
          <div>
        ...
        <div className="md:mt-20 lg:mt-12">
          ...
          <div>
            <p className="text-white opacity-70 font-extrabold md:mb-6 lg:mb-0 mt-3">
              Kenya
            </p>
          </div>
          <div>
            <p className="text-white opacity-70 font-extrabold mt-3">Global</p>
          </div>
        </div>
        ...
        <div className="mt-20 lg:mt-12">
          ...
          <div>
            <p className="text-white font-extrabold mb-6 lg:mb-0 mt-3">
              Ksh. 30 + 3%
            </p>
          </div>
          <div>
